...
# 3. Path to the cloned Godspeed docs repo
repo_path = "../gs-documentation"  # Update if your repo is elsewhere
...
if __name__ == "__main__":
    ...
    print("You can ask questions about the Godspeed framework.")
    while True:
        user_query = input("\nAsk a question (or type 'exit' to quit): ")
        if user_query.lower() == 'exit':
            break
        print("\nSearching Godspeed documentation...")
